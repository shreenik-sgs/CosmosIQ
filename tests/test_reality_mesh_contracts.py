...
def _one_of_each():
    ...
    return {
        ...
        "finding": M.AgentFinding(
            finding_id="F1", agent_id="tattva.market_regime", agent_layer="Tattva",
        ...
        "envelope": M.HandoffEnvelope(
            envelope_id="H1", created_at="2026-06-29T00:00:00Z", from_layer="Tattva",
            to_layer="Sphurana", from_agent="tattva.market_regime",
            to_synthesizer="TattvaSignalFusion", payload_type="AgentFinding",
